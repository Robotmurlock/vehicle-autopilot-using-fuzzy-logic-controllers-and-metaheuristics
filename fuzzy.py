...
FSAngle = FuzzySystem(np.array([left_sensor, front_sensor, right_sensor]), f_angle, angle_rules)
FSVelocity = FuzzySystem(np.array([left_sensor, front_sensor, right_sensor]), f_velocity, velocity_rules)
